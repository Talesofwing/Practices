    ...
    void Rope::simulateEuler(float delta_t, Vector2D gravity)
    {
        ...
        for (auto &m : masses)
        {
            if (!m->pinned)
            {
                ...
                /*
                // Explicit Euler method: the next position is calculated using the current velocity.
                ...
                */
                ...
                /*
                // Implicit Euler method: the next position is calculated using the next velocity.
                auto a  = m->forces / m->mass + gravity;
                m->velocity += a * delta_t;
                m->position += m->velocity * delta_t;
                */
