...
const TGAColor TGAColor::red = TGAColor(0, 0, 255, 255);
const TGAColor TGAColor::green = TGAColor(0, 255, 0, 255);
const TGAColor TGAColor::blue = TGAColor(255, 0, 0, 255);
const TGAColor TGAColor::yellow = TGAColor(0, 255, 255, 255);
